...
export default function Home() {
  return <><Navbar /><main id="top"><section className="hero shell"><p className="eyebrow">FRG Aguitez — portfolio</p><h1>Building web products with <em>considered systems</em> and human interfaces.</h1><div className="hero-lower"><p>{site.description}</p><div className="hero-actions"><a className="button button-dark" href="#work">View selected work <ArrowDown /></a><a className="button button-quiet" href="/resume.pdf" target="_blank" rel="noreferrer">View résumé <ArrowUpRight /></a><a className="hero-email" href={`mailto:${site.email}`}>Start a conversation <ArrowUpRight /></a></div></div><div className="hero-meta"><span>Based in the Philippines</span><span>Available for software engineering opportunities</span></div></section>
